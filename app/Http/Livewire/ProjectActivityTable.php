    ...
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('activities.deliverable', function (Activity $model) {
                ...
                return is_null($model->deliverable) ? '' : '<a download class="btn btn-warning btn-outline" href="'. asset('storage/deliverables/'.$model->deliverable) .'">Download Deliverable</a>';
            })
