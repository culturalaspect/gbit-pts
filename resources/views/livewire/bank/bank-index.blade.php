    ...
    <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                      ...
                      ">
                            ...
                            <div class="ms-2 align-self-center">
                                <h3 class="mb-0">{{ $top_cards_data['total_sanctioned']->total_sanctioned_companies }}
                                </h3>
        ...
        <div class="row mt-2">
                                ...
                                <div class="row list-inline d-flex justify-content-center align-items-center mb-2">
                                    <div class="col-lg-7">
                                        <h6 class="text-info mb-0"><i class="fa fa-circle font-10 me-2 "></i><a
                                                href="{{ url('bank/companyprogress/' . $company->id . '/' . $company->phase_id) }}">{{ $company->company_name }}</a>
                                        </h6>
                                    </div>
                                    <div class="col-lg-3">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Companies Financial Information</h4>
                        <h6 class="card-subtitle">List of companies with relative financial information.</h6>
