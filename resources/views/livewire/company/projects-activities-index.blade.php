                ...
                <div class="col-12">
                    <div class="card mt-3">
                        ...
                        <div class="card-header row">
                            <div class="col-lg-12">
                                <h3 class="card-title custom-card-title">{{ $project->project_title }}</h3>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($project->activities as $activity)
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-outline btn-warning" href="{{ url('company/activities/'.$activity->id) }}"><span class="fa fa-eye"></span> View</a></td>
                                                </tr>
                                                <?php $i++; ?>
                                            @endforeach
                                        </tbody>
