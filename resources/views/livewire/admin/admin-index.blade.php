                    ...
                    <div class="card-body">
                      ...
                      ">
                            ...
                            <div class="ms-2 align-self-center">
                                <h3 class="mb-0">PKR {{ $top_cards_data['schemes_sum']->total_approved_amount }} M</h3>
                ...
                <div class="card mt-2">
                    <div class="card-body">
                      ...
                      ">
                            ...
                            <div class="ms-2 align-self-center">
                                <h3 class="mb-0">PKR {{ $top_cards_data['total_sanctioned']->total_sanctioned_amount }} M</h3>
                ...
                <div class="card mt-2">
                    <div class="card-body">
                      ...
                      ">
                            ...
                            <div class="ms-2 align-self-center">
                                <h3 class="mb-0">{{ $top_cards_data['total_sanctioned']->total_sanctioned_companies }}</h3>
        ...
        <div class="row gx-3">
            ...
            <div class="col-md-4 col-lg-2 col-6">
              <div class="card text-white bg-warning rounded">
                <div class="card-body">
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users feather-lg fill-white"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                  </span>
                  <h3 class="card-title mt-3 mb-0 text-white">{{ $activities[0]->total_in_progress_activities }}</h3>
                  <p class="card-text text-white-50 fs-3 fw-normal">
            ...
            <div class="col-md-4 col-lg-2 col-6">
              <div class="card text-white bg-danger rounded">
                <div class="card-body">
                  ...
                  <h3 class="card-title mt-3 mb-0 text-white">{{ $activities[0]->total_in_completed_activities }}</h3>
                  <p class="card-text text-white-50 fs-3 fw-normal">
            ...
            <div class="col-md-4 col-lg-2 col-6">
              <div class="card text-white bg-info rounded">
                <div class="card-body">
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-credit-card feather-lg fill-white"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line></svg>
                  </span>
                  <h3 class="card-title mt-3 mb-0 text-white">{{ $activities[0]->total_in_not_applicable_activities }}</h3>
                  <p class="card-text text-white-50 fs-3 fw-normal">
                    Activities N/A
                  </p>
                </div>
            ...
            <div class="col-md-4 col-lg-2 col-6">
              <div class="card text-white bg-secondary rounded">
                <div class="card-body">
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github feather-lg fill-white"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                  </span>
                  <h3 class="card-title mt-3 mb-0 text-white">{{ round(($activities[0]->total_in_completed_activities/$activities[0]->total_activities)*100, 2) }} %</h3>
                  <p class="card-text text-white-50 fs-3 fw-normal">
                    Completion Ratio
                  </p>
                </div>
                            ...
                            @foreach($companies as $company)
                                <div class="progress mb-2">
                                    <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="20"
                                        aria-valuemin="0" aria-valuemax="100" style="width: {{ ($company->total_sanctioned_amount_in_m/$top_cards_data['total_sanctioned']->total_sanctioned_amount)*100 }}%">
                                    </div>
                                </div>
                                <div class="row list-inline d-flex justify-content-center align-items-center mb-2">
                                    <div class="col-lg-7">
                                        <h6 class="text-info mb-0"><i class="fa fa-circle font-10 me-2 "></i><a
                                                href="{{ url('admin/companyprogress/'.$company->id.'/'.$company->phase_id) }}">{{ $company->company_name }}</a></h6>
                                    </div>
                                    <div class="col-lg-3">
                                        <h6 class=" text-success mb-0"><i class="fa fa-circle font-10 me-2"></i>{{ $company->phase_name }}
                                        </h6>
                                    </div>
                                    <div class="col-lg-2">
                                        <h6 class=" text-danger mb-0"><i class="fa fa-circle font-10 me-2"></i>{{ $company->total_sanctioned_amount_in_m }} M</h6>
                                    </div>
                                </div>
                            @endforeach
                        </div>
        ...
        <div class="container-fluid">
            <div class="row mt-2">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="border-bottom">
                            <h5 style="font-size:16px;" class="card-title mb-0 text-center p-10">District Wise Loan Disbursed (Companies)</h5>
                        </div>
                        <div class="card-body">
                            <div>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="border-bottom">
                            <h5 style="font-size:16px;" class="card-title mb-0 text-center p-10">District Wise Loan Disbursed (Amount)</h5>
                        </div>
                        <div class="card-body">
                            <div>
                                <div class="chartjs-size-monitor"
                                ...
                                <canvas id="bar-chart-horizontal" height="319" width="640"
                                    style="display: block; height: 213px; width: 427px;" class="chartjs-render-monitor">
                                </canvas>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
            <div class="row mt-2">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="border-bottom">
                            <h5 style="font-size:16px;" class="card-title mb-0 text-center p-10">Category Wise Loan Disbursed (Amount)</h5>
                        </div>
                        <div class="card-body">
                            <div>
                                <div class="chartjs-size-monitor"
