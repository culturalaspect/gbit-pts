            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" wire:model.lazy="district_name" class="form-control"  placeholder="District Name"/>
                ...
                <div class="modal-footer">
                    ...
                    {{-- <button type="button" wire:click.prevent="save()" class="btn btn-success">
                        Save changes
                    </button> --}}
